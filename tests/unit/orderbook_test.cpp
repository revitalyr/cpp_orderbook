...
struct TestOrderBookListener : ExchangeListener { // Renamed to camelCase
...
TEST_CASE("OrderBook cancel order", "[orderbook]") {
    ...
    auto order1 = TestOrder::create(orderbook::ExchangeId(1), orderbook::Price(100), orderbook::Quantity(10), orderbook::Order::Side::BUY);
    ...
    auto order2 = TestOrder::create(orderbook::ExchangeId(1), orderbook::Price(100), orderbook::Quantity(10), orderbook::Order::Side::BUY);
    orderBook.insertOrder(order2);
    auto order3 = TestOrder::create(orderbook::ExchangeId(2), orderbook::Price(90), orderbook::Quantity(10), orderbook::Order::Side::BUY);
    orderBook.insertOrder(order3);
    auto order4 = TestOrder::create(orderbook::ExchangeId(3), orderbook::Price(80), orderbook::Quantity(10), orderbook::Order::Side::BUY);
...
TEST_CASE("OrderBook book levels sum", "[orderbook]") {
    ...
    auto order1 = TestOrder::create(orderbook::ExchangeId(1), orderbook::Price(100), orderbook::Quantity(10), orderbook::Order::Side::BUY);
    orderBook.insertOrder(order1);
    auto order2 = TestOrder::create(orderbook::ExchangeId(2), orderbook::Price(100), orderbook::Quantity(10), orderbook::Order::Side::BUY);
    orderBook.insertOrder(order2);
...
TEST_CASE("OrderBook book levels multiple", "[orderbook]") {
    ...
    auto order2 = TestOrder::create(orderbook::ExchangeId(2), orderbook::Price(100), orderbook::Quantity(10), orderbook::Order::Side::BUY);
    orderBook.insertOrder(order2);
    auto order3 = TestOrder::create(orderbook::ExchangeId(3), orderbook::Price(200), orderbook::Quantity(30), orderbook::Order::Side::BUY);
    orderBook.insertOrder(order3);
...
TEST_CASE("OrderBook session ID comparison", "[orderbook]") {
    const std::string session_1(orderbook::EngineConstants::kTestSessionId); // Renamed to kPascalCase
