...
This is an ultra high performance C++ implementation of a financial exchange order book capable of processing more than 5M orders per second per cpu core. It is inspired by the Go version in [go-trader](https://github.com/robaho/go-trader).
